...
pub use tournament_based_crossover_selection::{
    TournamentBasedCrossoverSelection, TournamentBasedCrossoverSelectionSettings,
};

mod elitist_next_generation_selector;
pub use elitist_next_generation_selector::{
    ElitistNextGenSelector, ElitistNextGenSelectorSettings,
};

mod patience_based_termination_strategy;
pub use patience_based_termination_strategy::{
    PatienceBasedTerminationStrategy, PatienceBasedTerminationStrategySettings,
};
