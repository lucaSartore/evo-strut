use crate::{
    evolution::PopulationInitializer, models::Settings,
...
impl<'a> PopulationInitializer<SupportStructureGene, SupportStructureInitializerSettings<'a>>
    for SupportStructureInitializer<'a>
{
    fn new(
        settings: &SupportStructureInitializerSettings<'a>,
        _rand: crate::evolution::Random,
    ) -> Self {
        Self {
