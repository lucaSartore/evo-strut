...
impl<'a> Crossover<ContactPointsGene, ContactPointCrossoverSettings<'a>>
    for ContactPointCrossover<'a>
{
    ...
    fn crossover(&self, a: &ContactPointsGene, b: &ContactPointsGene) -> ContactPointsGene {
        ...
        let (p1, p2, p3) = (
            self.graph.get_triangle(p1_id).center(),
            self.graph.get_triangle(p2_id).center(),
            self.graph.get_triangle(p3_id).center(),
        );
