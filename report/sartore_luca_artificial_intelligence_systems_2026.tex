...
\definecolor{tablegreen}{HTML}{2E8B57}
\definecolor{tablegold}{HTML}{B8860B}
\definecolor{tablered}{HTML}{FF4D4D}

\newcommand{\stiffparallel}{\mathbin{/\mkern-6mu/}}
\newcommand{\stiffseries}{\mathbin{\odot}}


% custom breakablealgorithm command (not used for now)
% \makeatletter
% % --- non-floating, page-breakable clone of "algorithm" ---------------
...
%   }
%   {\kern2pt\hrule\addvspace{\topsep}}

% % --- forbid breaks between algorithm lines by default ----------------
% \newcommand{\algnobreaks}{\@itempenalty=10000 \interlinepenalty=10000 \relax}
% \makeatother

% \newcommand{\algmaybreak}{\pagebreak[3]}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%      
      ...
      % chapters
      \input{introduction}
      \input{previous_literature}
      \input{motivations}
      \input{approximated_stiffness_evaluation}
      \input{support_optimization_algorithm}
      \input{results}
      \input{conclusions}
